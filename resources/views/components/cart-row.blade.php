...
<tr class="table_row" id={{$cartItem->id}}>
    ...
    <td class="column-4">
        <div class="wrap-num-product flex-w m-l-auto m-r-0">
            <button class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m" name="num-product1" onclick="updateCart('down')">
                <i class="fs-16 zmdi zmdi-minus"></i>
            </button>

            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value={{$cartItem->desired_quantity}} onchange="updateCart()">
